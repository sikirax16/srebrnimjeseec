                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        @foreach($images as $image)
                            <div class="col-xs-4 col-md-3 slike-dashboard">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::submit('Submit', array('class'=>'btn btn-lg btn-primary col-xs-12 col-md-4'))!!}
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        @foreach($haircut as $price)
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::submit('Update', array('class'=>'btn btn-lg btn-success col-xs-12 col-md-2 gumb'))!!}
                                    ...
                                    {{ Form::hidden('id', $price->id) }}
                                    {!! Form::submit('Delete', array('class'=>'btn btn-lg btn-danger col-xs-12 col-md-2'))!!}
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::submit('Submit', array('class'=>'btn btn-lg btn-primary col-xs-12 col-md-3'))!!}
                        {!! Form::close() !!}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            @foreach($massage as $price)
                                    ...
                                    {!! Form::submit('Update', array('class'=>'btn btn-lg btn-success col-xs-12 col-md-1 gumb'))!!}
                                    {!! Form::close() !!}

                                    {!! Form::open(array('url'=>'home/masaza_de','method'=>'DELETE')) !!}
                                    {{ Form::hidden('id', $price->id) }}
                                    {!! Form::submit('Delete', array('class'=>'btn btn-lg btn-danger col-xs-12 col-md-1 '))!!}
                                    {!! Form::close() !!}
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::submit('Submit', array('class'=>'btn btn-lg btn-primary col-xs-12 col-md-2'))!!}
                        {!! Form::close() !!}
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach($depilation as $price)
                                ...
                                @endif
                                    ...
                                    {{ Form::hidden('id', $price->id) }}
                                    {!! Form::submit('Delete', array('class'=>'btn btn-lg btn-danger col-xs-12 col-md-1 gumb'))!!}
                                    {!! Form::close() !!}
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            @foreach($oglasi as $part)
                                ...
                                @endif
                                    ...
                                    {!! Form::submit('Update', array('class'=>'btn btn-lg btn-success col-xs-12 col-md-5 col-xs-offset-1 gumb'))!!}
                                    {!! Form::close() !!}


                                    {!! Form::open(array('url'=>'home/oglas_delete','method'=>'DELETE')) !!}
                                    {{ Form::hidden('id', $part->id) }}
                                    {!! Form::submit('Delete', array('class'=>'btn btn-lg btn-danger col-xs-12 col-md-5 gumb'))!!}
                                    {!! Form::close() !!}
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::submit('Submit', array('class'=>'btn btn-lg btn-primary col-xs-12 col-md-4 gumb'))!!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
